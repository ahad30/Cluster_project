...
This feature prevents the forced shutdown of the antivirus using the "Task Manager," a common tactic employed by modern Trojans. These Trojans can gain administrative rights on an infected PC and block the operation of installed programs, including outdated antiviruses. Cluster's self-defense mechanism ensures that your PC remains protected, even against such advanced threats.`,
        ...
        {
          title:
            "Heuristic Analysis Technology - Detection of New and Unknown Threats",
...
- **Selective Scan**: Allows the user to scan specific files or folders.`,
      ...
      },
   {
      ...
      },
     {
        title: "USB - protection",
        childDescription:
          '<p><span style="font-size:14px">Security module of USB-drives controls the connection of any drive to the USB-ports. Preliminary analysis with following informing of user reliably protects the computer from automatically downloaded objects on disks. So now Cluster will protect you from the automatic start from the flash drive of a potentially malicious program.</span></p>',
      },
     {
        title: "Mail Filter",
        childDescription:
